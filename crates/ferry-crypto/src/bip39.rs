//! BIP-39 standard English wordlist and 6-word pairing mnemonic derivation.

/// Complete 2048-word BIP-39 English wordlist.
pub static BIP39_WORDS: [&str; 2048] = [
    ...
    "pigeon", "pill", "pilot", "pin", "pine", "pipe", "pistol", "pitch", "pizza", "place",
    ...
    "say", "scale", "scan", "scare", "scatter", "scene", "scheme", "school", "science",
    ...
    "subway", "success", "such", "sudden", "suffer", "sugar", "suggest", "suit", "sullen",
    ...
    "task", "taste", "tattoo", "taxi", "teach", "team", "tell", "ten", "tenant", "tennis", "tent",
    "term", "test", "text", "thank", "that", "theme", "then", "theory", "there", "they", "thing",
    ...
    "vague", "valley", "valve", "van", "vanish", "vapor", "various", "vast", "vault",
...
/// Look up index of a word in `BIP39_WORDS`.
#[must_use]
...
mod tests {
    ...
    #[test]
    fn bip39_wordlist_length_and_sorting() {
        assert_eq!(BIP39_WORDS.len(), 2048);
        for i in 1..BIP39_WORDS.len() {
            assert!(
                BIP39_WORDS[i - 1] < BIP39_WORDS[i],
                "words not strictly sorted: {} vs {}",
                BIP39_WORDS[i - 1],
                BIP39_WORDS[i]
            );
        }
    ...
    fn lookup_finds_known_words() {
        ...
        assert_eq!(word_index("beach"), Some(155));
        assert_eq!(word_index("drift"), Some(534));
        assert_eq!(word_index("river"), Some(1494));
